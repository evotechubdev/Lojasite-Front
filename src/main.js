...
function renderPortal() {
  ...
  <main>
  <section class="portal-hero portal-page-section" id="sua-loja"><div><span class="kicker">SUA LOJA ONLINE, VENDAS QUE GERAM RESULTADOS</span><h1>Tenha sua loja online e venda pela internet agora mesmo</h1><p>Tenha um mostruário profissional, organize produtos e venda pelo próprio site — com uma experiência segura, prática e feita para o seu negócio.</p><a class="portal-primary" href="#vitrine">Conhecer a ${escapeHtml(systemConfig.name)} <span>↓</span></a></div><div class="portal-window"><div class="window-bar"><i></i><i></i><i></i><small>lojasite.com.br/sua-loja</small></div><div class="window-content"><span class="your-logo-placeholder">Sua Logo</span><div><small>SEU NEGÓCIO ONLINE</small><strong>Estoque, vitrine e vendas em <b>um só lugar</b></strong></div></div></div><div class="hero-store-access-block"><div class="store-access-guidance"><span>Digite o complemento do link da loja informado pelo desenvolvedor.</span><button id="access-link-help" type="button">OBS</button></div><form class="hero-store-access" id="portal-access-form"><span>lojasite.com.br/</span><input name="suffix" placeholder="sua_organizacao" pattern="[a-zA-Z0-9_-]+" required><button type="submit">Acessar minha loja</button></form></div></section>

...
async function openCorporate(page) {
  ...
  if (page === 'products') {
    ...
    $('#product-price').onblur=event=>{formatBrazilianPriceInput(event.currentTarget);updateProductSubmit();};

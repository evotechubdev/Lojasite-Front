...
function renderPortal() {
  ...
  $('#app').innerHTML = `<div class="portal"><header class="header portal-header"><a class="logo portal-logo portal-logo-only" href="${import.meta.env.BASE_URL}" aria-label="LojaSite"><img src="${import.meta.env.BASE_URL}imagens_pub/logo.png" alt="Logo LojaSite"></a><nav><a href="#como-funciona">Como funciona</a><a href="#manual">Manual</a><a href="#contato">Contato</a></nav><a class="portal-access" href="#acessar">Acessar uma loja</a></header>
  ...
  <footer class="portal-simple-footer"><img src="${import.meta.env.BASE_URL}imagens_pub/logo_dev.png" alt="Logo EVOTECHUB"><span>© EVOTECHUB 2026 - Todos os direitos reservados.</span></footer></div>`;

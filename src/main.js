...
function renderApp() {
  ...
  $('#full-address')?.addEventListener('click',event=>{const details=$('#place-details-compact-container');if(!details)return;const willOpen=details.hidden;details.hidden=!willOpen;event.currentTarget.setAttribute('aria-expanded',String(willOpen));});
